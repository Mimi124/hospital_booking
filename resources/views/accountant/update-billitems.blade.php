      ...
      @include('accountant.navbar')
        ...
        <!-- partial -->
                ...
                <div class="mb-3">
                      ...
                      <form  action="{{url('editBillItem')}}"
                        method="POST"
                        enctype="multipart/form-data">
                          @csrf
                          <div class="mb-3">
                            <label for="name" class="form-label">Name</label>
                            <input class="form-control" style="color:black" type="name" name="name" id="name"
                            placeholder="Item Name" value="$billitem->item_name"
                            >
                          </div>
                          <div class="mb-3">
